...
export { default as VCard } from "./molecules/components/user/loggedAvatar";
export { default as Modal } from "./molecules/components/modal";
...
export { default as ShoppingCart } from "./molecules/components/shoopCart";
