...
const HeaderResponsive = ({
  ...
  console.log("HeaderResponsive", JSON.stringify(user, null, 2));
    ...
    <>
      <Header className={`m-w-full ${className} grid grid-cols-12`}>
        ...
        <div className="col-span-3 grid grid-cols-4">
          <div className="col-span-3 cell">
            <ShoppingCart className={user ? "block" : "hidden"} />
          </div>
          <div className="cell">
            {user ? (
      ...
      <Aside
        items={items}
        className="mt-20 md:hidden bg-blue"
