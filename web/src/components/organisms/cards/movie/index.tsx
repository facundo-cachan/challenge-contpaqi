...
const CardMovie = ({ id, title, poster_path, release_date, primaryAction }: CardMovieProps) => {
  ...
  return (<li className="m-4 transition-shadow duration-300 ease-in-out rounded-md shadow-md group/item bg-slate-300 hover:shadow-xl hover:shadow-red-500">
      <Button data-role="tooltip" className="z-30 w-full rounded-bl-md rounded-tr-md" aria-label="Add Favorites" onClick={primaryAction}>
