...
import { genres, guest_session, now_playing, type Movie } from '../services/themoviedb';
...
const Layout = (): JSX.Element => {
  ...
  return (<main className="flex flex-col">
    <HeaderResponsive items={items}>
      <Input type="search" placeholder="Search movies" className="w-80" onChange={filterMovie} style={{ height: 44 }} />
