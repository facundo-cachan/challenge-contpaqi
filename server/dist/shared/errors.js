...
exports.RoomNotFoundError = exports.UnauthorizedError = exports.UserCanBeDeleted = exports.UserNotFoundError = exports.ParamMissingError = exports.CustomError = void 0;
...
class UserCanBeDeleted extends CustomError {
    constructor() {
        super(UserNotFoundError.Msg, UserNotFoundError.HttpStatus);
    }
}
exports.UserCanBeDeleted = UserCanBeDeleted;
UserCanBeDeleted.Msg = "A user can be deleted.";
UserCanBeDeleted.HttpStatus = http_status_codes_1.default.NOT_FOUND;
